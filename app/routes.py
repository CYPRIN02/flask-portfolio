...
def home():
    ...
    return render_template('index.html', title='Home', projects=projects, skills=skills)
...
def about():
    ...
    return render_template('about.html', title='About', education=education, experience=experience)
